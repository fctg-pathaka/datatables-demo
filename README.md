...
1. Open pom.xml file in intellij using File->open or normal flow.
2. Let intellij configure the project
3. Import dependancies from maven view in intellij
4. Run command: clean install
5. Goto root directory containing pom.xml and run:mvn spring-boot:run

Launch :http://localhost:8080/

Refer:# springboot-sample-app
...
the `de.codecentric.springbootsample.Application` class from your IDE.
